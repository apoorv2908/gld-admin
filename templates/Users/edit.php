  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">GlobalLawDirectory</span>
      </a>
    ...
    <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        ...
        <li>
            <?= $this->Html->link(
                ...
                ['controller' => 'PracticeAreas', 'action' => 'index'],
                ['escape' => false, 'class' => 'nav-link']
            ) ?>
        </li>
        <li>
...
<li class="nav-item">
    <?= $this->Html->link(
        '<i class="bi bi-substack"></i><span> Blogs</span>', 
...
<li class="nav-item">
    <?= $this->Html->link(
        '<i class="bi bi-cash-stack"></i><span>Transactions</span>', 
        ...
        <div class="card">
            <div class="card-body">
                ...
                <?= $this->Form->create($user, ['class' => 'row g-3']) ?>
                    <div class="col-12">
                        <?= $this->Form->control('email', ['class' => 'form-control', 'label' => ['class' => 'form-label', 'text' => 'Email']]) ?>
                    </div>
                    <div class="col-12">
                        <?= $this->Form->control('password', ['class' => 'form-control', 'label' => ['class' => 'form-label', 'text' => 'Password']]) ?>
                    </div>
