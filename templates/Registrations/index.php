              ...
              <table class="table datatable">
                ...
                foreach ($registrations as $index => $registration): ?>
                 <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link(__('View'), ['action' => 'view', $registration->sno]) ?>
                        <?= $this->Html->link(__('Edit'), ['action' => 'edit', $registration->sno]) ?>
                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $registration->sno], ['confirm' => __('Are you sure you want to delete # {0}?', $registration->sno)]) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
