...
// Set the page title
$this->assign('title', 'All Listings');
?>

<div class="content-header">
    <div >
        <h1 class="content-title"><?= __('All Listings') ?></h1>
    </div>
</div>
...
?>
   ...
   <?= $this->Form->select('status', [
    ...
    'action' => ($listing->listing_type === 'Lawyer') ? 'editLawyerPage' : 'editLawfirmPage', 
    $listing->id
    ...
    <?= $this->Form->postLink(
        ...
        [
            ...
            'class' => 'bi bi-trash3 text-danger ms-3' // Bootstrap-styled button
        ]
    ) ?>
</td>
