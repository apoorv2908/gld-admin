...
<?= $this->element('sidebar') ?>
    ...
    <div class ="mx-4">
      ...
      <h4><?= __('List of Admin(s)') ?></h4>
      <?= $this->Html->link(__('+ New Admin'), ['action' => 'add'], ['class' => 'btn btn-primary float-end mb-3']) ?>
</div>
        ...
        foreach ($admin as $index => $admin): ?>
                <tr>
                   ...
                   <td >
                   <a href="<?= $this->Url->build(['action' => 'edit', $admin->id]) ?>" class="btn btn-primary btn-sm">
        <?= __('Edit') ?>
    </a>
